...
const WebvireUI = {
  ...
  renderHeader(activePage = 'home') {
    ...
    if (topbarTarget && (!topbarTarget.children || topbarTarget.children.length === 0)) {
      topbarTarget.innerHTML = `
        <div class="topbar">
          <div class="container">
            <div class="topbar-info">
              <span><i class="fa-solid fa-phone"></i> +91 7309277237</span>
              <span><i class="fa-solid fa-envelope"></i> info@webvire.com</span>
              <span><i class="fa-solid fa-location-dot"></i> Lucknow, Uttar Pradesh, India</span>
            </div>
    ...
    if (headerTarget && (!headerTarget.children || headerTarget.children.length === 0)) {
      headerTarget.innerHTML = `
        <header class="nav-header">
          <div class="container nav-inner">
            ...
            <nav class="nav-links">
              <a href="/" class="${activePage === 'index' || activePage === 'home' ? 'active' : ''}">Home</a>
              ...
              <a href="/it-solutions" class="${activePage === 'it-solutions' ? 'active' : ''}">IT Solutions</a>
              <a href="/careers" class="${activePage === 'careers' ? 'active' : ''}">Careers</a>
              <a href="/contact" class="${activePage === 'contact' ? 'active' : ''}">Contact Us</a>
            </nav>
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
              ...
              <a href="/contact" class="btn btn-primary nav-cta-btn">Get Quote <i class="fa-solid fa-arrow-right"></i></a>
  ...
  renderFooter() {
    ...
    if (!footerTarget || (footerTarget.children && footerTarget.children.length > 0)) return;
        ...
        <div class="container">
          <div class="footer-grid">
            ...
            <div>
              <h3>Get In Touch</h3>
              <div class="footer-links">
                <span><i class="fa-solid fa-location-dot" style="color: var(--cyan-glow); margin-right: 8px;"></i> Lucknow, Uttar Pradesh, India</span>
    ...
    if (!overlay) {
      ...
      drawer.innerHTML = `
        ...
        <div style="padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.1); display: flex; flex-direction: column; gap: 12px;">
          ...
          <a href="/contact" class="btn btn-primary" style="width: 100%;">Get In Touch <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      `;
